...
export interface SystemLog {
  ...
  userId: string;
  userName: string;
  action: 'LOGIN' | 'LOGOUT' | 'CREATE_INCIDENT' | 'UPDATE_INCIDENT' | 'APPROVE_INCIDENT' | 'DELETE_RESOURCE' | 'USER_REGISTER' | 'DELETE_USER' | 'CREATE_ASSET' | 'UPDATE_ASSET' | 'DELETE_ASSET' | 'LOAN_CREATE' | 'LOAN_CONFIRM' | 'LOAN_RETURN' | 'UPDATE_PERMISSIONS' | 'MANAGE_SETTINGS' | 'DATABASE_TOOLS' | 'DELETE_BUILDING' | 'DELETE_SECTOR' | 'DELETE_JOB_TITLE' | 'DELETE_ALTERATION_TYPE';
  details: string;
  timestamp: string;
}
