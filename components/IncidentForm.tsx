...
export const IncidentForm: React.FC<IncidentFormProps> = ({
    ...
    return (
        <div className="max-w-4xl mx-auto animate-fade-in space-y-4 mb-20">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden transition-all animate-in zoom-in-95 duration-300">
                {/* HEADER MODERNO */}
